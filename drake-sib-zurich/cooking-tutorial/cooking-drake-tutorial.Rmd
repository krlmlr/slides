...
The *cooking* and *drake* packages are loaded for all exercises:
...
```{r drake-buy-view, exercise=TRUE, exercise.eval = TRUE, exercise.setup = "drake-buy-solution"}
plan
str(plan)
```
...
Show the contents of the newly created target:
...
```{r drake-fry-make, exercise=TRUE, exercise.setup = "drake-fry-solution"}
