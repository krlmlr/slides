...
Use the `buy()` function to buy meat. Fill in the dots. (The *cooking* package is already loaded.)
...
We have our `ragout`, and or `slice()` and `dice()` functions
